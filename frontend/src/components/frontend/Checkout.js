...
function Checkout() {
  ...
  // Update the submitOrder function to handle the new payment mode "cod"
  const submitOrder = async (e, payment_mode) => {
    ...
    if (payment_mode === "cod" && !data.address) {
      swal("Bạn phải điền địa chỉ giao hàng!", "", "error");
      return;
    }
                  ...
                  <div className="col-md-6">
                    <div className="form-group mb-3">
                      ...
                      <input
                        ...
                        placeholder={"vd: TRAN TRONG NGHIA"}
                      />
