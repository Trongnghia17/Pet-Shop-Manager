          ...
          <div className="col col-lg-8 mb-4 mb-lg-0">
            <div className="card mb-3" style={{ borderRadius: ".5rem" }}>
              <div className="row g-0">
                ...
                >
                  <img
                    src={process.env.PUBLIC_URL + "/images/NghiaLogo.jpg"}
                    alt="Avatar"
                    className="img-fluid my-5 img-thumbnail"
                    style={{ width: "200px" }}
                  />
                  <h5>Trần Trọng Nghĩa</h5>
                  ...
                  <div className="card-body p-4">
                    ...
                    <div className="row pt-1">
                      <div className="col-6 mb-3">
                        <h6>Email</h6>
                        <p className="text-muted">trannghia270403@gmail.com</p>
                      </div>
                      <div class="col-6 mb-3">
                        <h6>Số điện thoại</h6>
                        <p className="text-muted">0338989024</p>
                      </div>
                    </div>
                    <div class="col-6 mb-3">
                      <h6>Địa chỉ</h6>
                      <p className="text-muted">Vũ Thư - Thái Bình</p>
                    </div>
                    <hr className="mt-0 mb-4" />
                    <div className="row pt-1">
                      <div className="col-6 mb-3">
                      ...
                      <div className="col-6 mb-3">
                        ...
                        <p className="text-muted">Kim Ngưu</p>
                      </div>
                    </div>
                    <div className="d-flex justify-content-center">
                      <a href="https://github.com/Trongnghia17">
                        <i
                          className="fab fa-github fa-lg me-3"
                          style={{ color: "black" }}
                        ></i>
                      </a>
                      <a href="https://web.facebook.com/Tran.Nghia.27042003">
